    ...
    <div className='relative h-screen text-white'>
      ...
      <div className='absolute top-0 left-0 w-full h-full flex flex-col px-8 md:px-16 lg:px-32 justify-center'>
        ...
        <div className='flex mt-8'>
          <Link to={'/watch/123'} className='bg-white hover:bg-black text-black font-bold py-2 px-4 rounded mr-4 flex items-center'>
            <Play className='size-6 mr-2 fill-black hover:fill-amber-700' />
            Play
          </Link>
          <Link to={'/watch/123'} className='bg-gray-500/70 hover:bg-white text-white py-2 px-4 rounded flex items-center'>
