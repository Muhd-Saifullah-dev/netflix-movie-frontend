...
import TvPng from '/public/tv.png';
import HeroVideo from '/public/hero-vid.m4v';
import StrangeImage from '/public/stranger-things-lg.png';
import StrangerThingSm from "/public/stranger-things-sm.png"
import DownloadGif from "/public/download-icon.gif"
import DevicePile from "/public/device-pile.png"
import VideoDevice from "/public/video-devices.m4v"
import KidPng from "/public/kids.png"
const AuthScreen = () => {
  return (
    <>
      {/* Hero Section */}
      <div className='hero-bg bg-cover bg-center relative'>
        ...
        <div className='flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-40 text-white'>
          ...
          <form action='' className='flex flex-col md:flex-row gap-4 w-1/2'>
            ...
            />
            <button className='bg-red-600 text-xl py-1 px-2 lg:text-xl lg:px-6 md:py-2 rounded flex justify-center items-center'>
              Get started
        ...
        <div className='flex max-w-6xl mx-auto justify-center items-center md:flex-row flex-col-reverse px-4 md:px-2'>
          ...
          <div className='flex-1'>
            ...
            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
              <img src={StrangerThingSm} alt="Stranger Image" className='h-full' />
          ...
          {/* Right Side */}
          <div className='flex-1 text-center md:text-left'>
            <h2 className='text-4xl md:text-5xl font-extrabold mb-4 text-balance leading-tight '>Download your shows to watch offline</h2>
            <p className='text-lg md:text-xl'>save your favourites easily and always something to watch.</p>
          </div>
        </div>
      </div>
      ...
      <div className='py-10 bg-black text-white'>
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
            ...
            <div className='flex-1 relative overflow-hidden'>
              <img src={DevicePile} alt='Tv Image' className='mt-4 z-20 relative' />
              <video
        ...
        <div className='py-10 bg-black text-white'>
          <div className='flex max-w-6xl mx-auto justify-center items-center flex-col-reverse md:flex-row px-4 md:px-2'>
            ...
            {/* right side  */}
            <div className="flex-1 text-center md:text-left">
              <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Creates profile for kids</h2>
              <p className='text-lg md:text-xl'>Send kids on adventures with their favourites characters in a space made just for them-free with your membership. </p>
            </div>
          </div>
        </div>
    </>
